...
# Contributing to @untitledq/password-utilities
...
1. **Clone the repository**:
   ```sh
   git clone https://github.com/WhenWenh/password-utilities.git
...
- **Commit Message Format**: Commit messages should be descriptive, e.g., `feat: add new xyz algorithm` following the [Conventional Commits Specification](https://www.conventionalcommits.org/en). It is easy to follow if you are using the [semantic-git-commit-cli](https://www.npmjs.com/package/semantic-git-commit-cli)
